...
public class MainLS {
    ...
    public void process(String[] args) {
        ...
        logger = Logger.getLogger(MainLS.class);
            ...
            while (i.hasNext()) {
                ...
                if ((prefix == null) || schema.prefix.equals(prefix)) {
                    ...
                    if((initialResumptionToken != null) && schema.prefix.equals(prefix)) {
                    	...
                    	listSets = new ListSets(url_str, resumptionToken);
                    } else {
                    	resumptionToken = "";
                    	//listRecords = new ListRecords(url_str, fromDate, untilDate, set, schema.prefix);
                    	listSets = new ListSets(url_str);
                    }
                    ...
                    while (listSets != null) {
                        ...
                        if (errors != null && errors.getLength() > 0) {
                            ...
                            fatal("Error record: " + listSets.toString());
                        }
    
                        //File file = getFile(base, resumptionToken, extension, 3);
                        if (logger.isInfoEnabled()) {
                            //NodeList records = listRecords.getNodeList("oai20:OAI-PMH/oai20:ListRecords/oai20:record");
                        	NodeList records = listSets.getNodeList("oai20:OAI-PMH/oai20:ListRecords/oai20:record");
                        ...
                        Source source = new DOMSource(listSets.getDocument());
                        //OutputStream outputStream = new BufferedOutputStream(new FileOutputStream(file));
                        //StreamResult result = new StreamResult(outputStream);
                        try {
